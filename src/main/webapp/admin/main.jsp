...
<div id="all">
    ...
    <div id="top">
        ...
        <div id="top3">
            ...
            <span><a href="${pageContext.request.contextPath}/admin/logout.action" <%--onclick="logout()"--%>
                     style="color: deepskyblue">退出</a></span>
        </div>
            ...
            <div id="lbottom">
                <ul>
                    ...
                    <a href="${pageContext.request.contextPath}/prod/split.action" target="myright">
                        <li class="two"><span class="glyphicon glyphicon-book" style="color: white;"></span>&nbsp;&nbsp;&nbsp;&nbsp;商品管理&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span
